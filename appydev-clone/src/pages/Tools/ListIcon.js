...
export const listIcon = [
  {
    name: 'All',
    icon: () => (
      <All width='18px' height='18px'/>
    )
  },
  {
    name: 'Api',
    icon: () => (
      <Api width='18px' height='18px'/>
    )
  },
  {
    name: 'BrowserExtensions',
    icon: () => (
      <BrowserExtensions width='18px' height='18px'/>
    )
  },
  {
    name: 'Career',
    icon: () => (
      <Career width='18px' height='18px'/>
    )
  },
  {
    name: 'Charts',
    icon: () => (
      <Charts width='18px' height='18px'/>
    )
  },
  {
    name: 'Cheatsheets',
    icon: () => (
      <Cheatsheets width='18px' height='18px'/>
    )
  },
  {
    name: 'CodeAutomation',
    icon: () => (
      <CodeAutomation width='18px' height='18px'/>
    )
  },
  {
    name: 'ContentNwriting',
    icon: () => (
      <ContentNwriting width='18px' height='18px'/>
    )
  },
  {
    name: 'CssFrameworks',
    icon: () => (
      <CssFrameworks width='18px' height='18px'/>
    )
  },
  {
    name: 'DesignMockup',
    icon: () => (
      <DesignMockup width='18px' height='18px'/>
    )
  },
  {
    name: 'DesignResources',
    icon: () => (
      <DesignResources width='18px' height='18px'/>
    )
  },
  {
    name: 'DesignTools',
    icon: () => (
      <DesignTools width='18px' height='18px'/>
    )
  },
  {
    name: 'DeveloperProductivity',
    icon: () => (
      <DeveloperProductivity width='18px' height='18px'/>
    )
  },
  {
    name: 'DeveloperResources',
    icon: () => (
      <DeveloperResources width='18px' height='18px'/>
    )
  },
  {
    name: 'DeveloperTools',
    icon: () => (
      <DeveloperTools width='18px' height='18px'/>
    )
  },
  {
    name: 'Education',
    icon: () => (
      <Education width='18px' height='18px'/>
    )
  },
  {
    name: 'EmailBuilders',
    icon: () => (
      <EmailBuilders width='18px' height='18px'/>
    )
  },
  {
    name: 'EmailTools',
    icon: () => (
      <EmailTools width='18px' height='18px'/>
    )
  },
  {
    name: 'Entertainment',
    icon: () => (
      <Entertainment width='18px' height='18px'/>
    )
  },
  {
    name: 'Freebies',
    icon: () => (
      <Freebies width='18px' height='18px'/>
    )
  },
  {
    name: 'Illustrations',
    icon: () => (
      <Illustrations width='18px' height='18px'/>
    )
  },
  {
    name: 'JsPlugins',
    icon: () => (
      <JsPlugins width='18px' height='18px'/>
    )
  },
  {
    name: 'LoadersNspinners',
    icon: () => (
      <LoadersNspinners width='18px' height='18px'/>
    )
  },
  {
    name: 'MarketingResources',
    icon: () => (
      <MarketingResources width='18px' height='18px'/>
    )
  },
  {
    name: 'Misc',
    icon: () => (
      <Misc width='18px' height='18px'/>
    )
  },
  {
    name: 'Nocode',
    icon: () => (
      <Nocode width='18px' height='18px'/>
    )
  },
  {
    name: 'Productivity',
    icon: () => (
      <Productivity width='18px' height='18px'/>
    )
  },
  {
    name: 'Seo',
    icon: () => (
      <Seo width='18px' height='18px'/>
    )
  },
  {
    name: 'StockAssets',
    icon: () => (
      <StockAssets width='18px' height='18px'/>
    )
  },
  {
    name: 'Wireframe',
    icon: () => (
      <Wireframe width='18px' height='18px'/>
    )
  },
  {
    name: 'productivity',
